...
namespace SpatialIndex
{
	...
	public:
		...
		virtual void getKeys(std::vector<id_type> *ids) = 0;
	...
	public:
		...
		virtual void visitUseless() = 0;
		virtual void visitData(const IData& in, id_type) = 0;
		virtual void visitData(std::vector<const IData*>& v) = 0;
		virtual bool doneVisiting() = 0;
		virtual ~IVisitor() {}
	}; // IVisitor
	...
	public:
		...
		virtual void intersectsWithQuery2(const Region& query, IVisitor& v) {};
		virtual void seedQuery(const IShape& query, IVisitor& v) {};
		virtual void seedKNN(const Point& query, IVisitor& v) {};
